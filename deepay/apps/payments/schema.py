...
from deepay.apps.captcha.models import Captcha
...
if typing.TYPE_CHECKING:
    from deepay.apps.basket.schema import BasketType
...
class OrderType:
    ...
    basket: typing.Annotated["BasketType", strawberry.lazy("deepay.apps.basket.schema")]
